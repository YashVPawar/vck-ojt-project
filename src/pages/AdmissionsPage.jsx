...
const Admissions = () => {
  return (
    <div className="admissions-container">
      ...
      <p>
        For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our <Link to="/cources">Cources page</Link> or <Link to="/contact">Contact us</Link> directly.
      </p>
    </div>
  );
};
